...
"""
    Ref: https://cocodataset.org/#panoptic-2020
"""
...
"""
    Ref: https://www.cityscapes-dataset.com/panoptic-segmentation/
        - Tool: covert to panoptic format - https://github.com/mcordts/cityscapesScripts
        - Folder: {root}/{type}{video}/{split}/{city}/{city}_{seq:0>6}_{frame:0>6}_{type}{ext}
        - export CITYSCAPES_DATASET=/media/rahul/Karmic/data/cityscapes/
"""
def prepare_panoptic_cityscapes():
    return None

"""
    Ref: http://www.cvlibs.net/datasets/kitti/eval_instance_seg.php?benchmark=instanceSeg2015
"""
def prepare_panoptic_kitti():
    return None

if __name__ == "__main__":
    prepare_panoptic_coco()
