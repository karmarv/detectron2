...
from modet.data.datasets.coco import load_coco_json, load_sem_seg
...
def register_coco_instances(name, metadata, json_file, image_root):
    ...
    logger.info("[MoDet] Loaded COCO format: {} - {}".format(image_root, json_file))
...
def register_coco_panoptic_separated(
    ...
    logger.info("[MoDet] Loaded COCO Panoptic: {}, Instance: {}".format(panoptic_json, instances_json))
