...
__all__ = ["build_meta_arch_panoptic_fpn_sg", "PanopticFPNMD"]

@META_ARCH_REGISTRY.register()
class PanopticFPNMD(nn.Module):
    """
    Implement the paper :paper:`PanopticFPNMD`.
    """
...
#@META_ARCH_REGISTRY.register()
def build_meta_arch_panoptic_fpn_sg(cfg):
    model = PanopticFPNMD(cfg)
    return model
